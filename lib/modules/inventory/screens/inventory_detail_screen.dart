          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${item.category}  •  ${item.metal} ${item.purity}  •  ${item.store.replaceAll('Rajmahal Jewellers - ', '')}',
                  style: const TextStyle(
  ...
  Widget _detailsTab(InventoryItem item) => ListView(
    ...
    children: [
      ...
      _card('Weight & Location', Icons.scale_outlined, [
        ...
        _row(
          'Location',
          item.showcaseLocation.isEmpty
              ? 'Not assigned'
              : item.showcaseLocation,
        ),
      ...
      _card('Hallmark & Certification', Icons.verified_outlined, [
        _row(
          'Certificate',
          item.hallmarkCert.isEmpty ? '—' : item.hallmarkCert,
        ),
        _row(
          'Hallmark Date',
          item.hallmarkDate == null ? '—' : _fmtDate(item.hallmarkDate!),
        ),
      ...
      ? Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              const Text(
                'No stone details for this item',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _priceRow(
                'Making Charge (${item.makingCharge.toStringAsFixed(0)}%)',
                _fmt(makingAmt),
              ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${t['from']?.toString().replaceAll('Rajmahal Jewellers - ', '')} → ${t['to']?.toString().replaceAll('Rajmahal Jewellers - ', '')}',
                          style: const TextStyle(
                            color: AppColors.textPrimary,
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton.icon(
            onPressed: () {
              // Pre-select this item in the invoice builder
              final ctrl = Get.find<BillingController>();
              ctrl.clearBuilder();
              ctrl.preSelectItem(item);
