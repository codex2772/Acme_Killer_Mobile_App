...
class _AddCustomerScreenState extends State<AddCustomerScreen> {
  ...
  Future<void> _submit() async {
    ...
    final tags = _tags.text
        ...
        .toList();
    final newId =
        'CUS${(_ctrl.customers.length + 1).toString().padLeft(3, '0')}';
    ...
    final customer = Customer(
      ...
      creditLimit: 100000,
      commSms: _commSms,
      commWhatsapp: _commWhatsapp,
      commEmail: _commEmail,
      tags: tags,
      ...
      preferences: CustomerPreferences(
        ...
        wristSize: _wristSize.text.trim(),
        chainLength: _chainLength.text.trim(),
        bangleSize: _bangleSize.text.trim(),
    ...
    if (!auth.isDemo.value) {
      ...
      try {
        final phoneCheck = await Get.find<CustomerService>().byPhone(
          phone.replaceAll(RegExp(r'[\s+\-]'), ''),
        );
        if (phoneCheck.success && phoneCheck.data != null) {
          ...
          Get.snackbar(
            'Duplicate',
            'Customer with this phone already exists in database',
            backgroundColor: AppColors.error.withOpacity(0.2),
            colorText: AppColors.error,
            snackPosition: SnackPosition.BOTTOM,
            margin: const EdgeInsets.all(12),
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            _row2(
              _tf(_name, 'Full Name *', validator: _req),
              _tf(
                _phone,
                'Phone *',
            ...
            _row2(
              _tf(_email, 'Email', keyboardType: TextInputType.emailAddress),
            ...
            Row(
              children: [
                ...
                _check(
                  'WhatsApp',
                  _commWhatsapp,
                  (v) => setState(() => _commWhatsapp = v!),
                ),
                _check(
                  'Email',
                  _commEmail,
                  (v) => setState(() => _commEmail = v!),
                ),
              ],
            ),
            ...
            _row3(
              ...
              _dd(
                'Purity',
                ['22K', '24K', '18K', '14K', '925 Silver', '950 Platinum'],
                _purity,
            ...
            _tf(
              ...
              hint: 'e.g., Festival Buyer, Gold Lover',
            ),
            _tf(
              _notes,
              'Notes',
              hint: 'Any special preferences...',
              maxLines: 3,
            ),
