...
class _EditStaffScreenState extends State<EditStaffScreen> {
  ...
  void initState() {
    ...
    _targetCtrl = TextEditingController(
      text: _staff.salesTarget.toStringAsFixed(0),
    );
    _aadhaarCtrl = TextEditingController(text: _staff.aadhaar);
    _panCtrl = TextEditingController(text: _staff.pan);
  ...
  Future<void> _submit() async {
    ...
    if (_ctrl.isOnline.value && _staff.backendId != null) {
      ...
      final updated = _ctrl.staffMembers.firstWhereOrNull(
        (s) => s.id == _staffId,
      );
      if (updated != null) {
      ...
      body: ListView(
        ...
        children: [
          ...
          _sectionCard(
            ...
            _row2(
              _tf(_aadhaarCtrl, 'Aadhaar Number'),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Full store operations. Revenue Dashboard exclusive to owner.',
                    ...
                    children: [
                      Checkbox(
                        ...
                        onChanged: (v) => setState(() {
                          if (v == true)
                            for (final p in perms) _perms.add(p.id);
                          else
                            for (final p in perms) _perms.remove(p.id);
                        }),
